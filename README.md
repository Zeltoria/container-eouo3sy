...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-eouo3sy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-eouo3sy.containers.anotherwebservice.com/
...
```
git clone git@github.com:Zeltoria/container-eouo3sy.git
cd container-eouo3sy
```
...
```
docker attach container-eouo3sy
```
